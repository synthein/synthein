function love.conf(t)
	t.identity = "synthein"              -- The name of the save directory (string)
	t.version = "11.2"                   -- The LÖVE version this game was made for (string)
	t.console = true                     -- Attach a console (boolean, Windows only)

	t.window.title = "Synthein"          -- The window title (string)
	t.window.icon = "res/images/gun.png" -- Filepath to an image to use as the window's icon (string)
