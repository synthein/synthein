...
SaveMenu.scrollSpeed = 150

-- Make a menu in the center of the screen from a list of buttons.
function SaveMenu.create(y, size, buttons)
	local self = {}
	setmetatable(self, SaveMenu)
...
function SaveMenu:resize(_, h) --(w, h)
...
function SaveMenu:wheelmoved(_, y) --(x, y)
	self.selectedButton = nil
